 ...
 * 
 */
API.prototype.sendMessage = function(first, text, parse, disable_web_page_preview, reply_to_message_id, reply_markup) {
    var options = _.isObject(first) ?
        first : {
            chat_id: first,
...
/**
 * Use this method to get the file path.
 * 
 * @category Telegram API
 * @param {srting} [file_id] file_id from Photo message object
 * 
 * 
 */

API.prototype.getFile = function(first) {
    var options = _.isObject(first) ?
        first : {
            file_id: first
        };
    return this.reqBot('getFile', options);
}
